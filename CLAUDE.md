...
This repo also has some raspberry pi config scripts in @rpi/ - if you need to
search the documentation for the latest raspbian (which these scripts use) then
that his available at
