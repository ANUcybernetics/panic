defmodule PanicWeb.UserSettingsControllerTest do
  ...
  describe "PUT /users/settings (change password form)" do
    test "updates the user password and resets tokens", %{conn: conn, user: user} do
      ...
      assert redirected_to(new_password_conn) ==
               Routes.live_path(conn, PanicWeb.EditPasswordLive)
  ...
  describe "GET /users/settings/confirm_email/:token" do
    ...
    test "updates the user email once", %{conn: conn, user: user, token: token, email: email} do
      ...
      assert redirected_to(conn) == Routes.live_path(conn, PanicWeb.EditProfileLive)
  ...
  describe "GET /users/unsubscribe/:code/:notification_subscription" do
    test "renders an unsubscribe page for that notification subscription", %{
      ...
      unsub_url =
        Panic.Accounts.NotificationSubscriptions.unsubscribe_url(
          user,
      ...
      assert response =~
               Panic.Accounts.NotificationSubscriptions.get("marketing_notifications").label
    end
  end
