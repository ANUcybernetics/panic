...
#   - https://hub.docker.com/_/debian?tab=tags&page=1&name=bookworm-20241203-slim - for the release image
#   - https://pkgs.org/ - resource for finding needed packages
#   - Ex: hexpm/elixir:1.18.4-erlang-27.2.2-debian-bookworm-20241203-slim
#
ARG ELIXIR_VERSION=1.18.4
ARG OTP_VERSION=27.2.2
ARG DEBIAN_VERSION=bookworm-20241203-slim
