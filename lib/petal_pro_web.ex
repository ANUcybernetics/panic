defmodule PetalProWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: PetalProWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {PetalProWeb.LayoutView, "live.html"}

      on_mount PetalProWeb.RestoreLocale
      unquote(view_helpers())
    end
  end
  ...
  defp view_helpers do
    quote do
      ...
      import PetalProWeb.ErrorHelpers
