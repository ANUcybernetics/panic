defmodule PanicWeb.Router do
  ...
  # NOTE: ash_ai dependency was removed, so this route is commented out
  # scope "/ash_ai/mcp" do
  #   pipe_through :mcp
  #
  ...
  scope "/", PanicWeb do
    ...
    auth_routes AuthController, Panic.Accounts.User
    reset_route auth_routes_prefix: "/auth"

    # Routes that don't need WatcherSubscriber
    ash_authentication_live_session :authentication_required,
      ...
      scope "/installations" do
        ...
        live "/:id/show/edit_watcher/:name", InstallationLive.Show, :edit_watcher
      end
