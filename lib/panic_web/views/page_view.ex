defmodule PanicWeb.PageView do
  use PanicWeb, :view
  ...
  def privacy_markdown(),
    ...
    #{Panic.config(:business_name)} takes your privacy seriously. To better protect your privacy we provide this privacy policy notice explaining the way your personal information is collected and used.
    ...
    For any questions or concerns regarding the privacy policy, please send us an email to #{Panic.config(:support_email)}.
    """
end
