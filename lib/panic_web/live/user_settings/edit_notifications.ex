defmodule PanicWeb.EditNotificationsLive do
  ...
  def render(assigns) do
    ~H"""
    <.settings_layout current={:edit_notifications} current_user={@current_user}>
      <.form id="update_profile_form" let={f} for={@changeset} phx-change="update_profile">
        <.form_field
          type="checkbox"
          form={f}
