defmodule PanicWeb.OrgLayoutComponent do
  @moduledoc """
  ...
  defp get_link(:org_dashboard, socket, org) do
    %{
      name: :org_dashboard,
      path: Routes.live_path(socket, PanicWeb.OrgDashboardLive, org.slug),
      label: "Dashboard",
  ...
  defp get_link(:org_settings, socket, org) do
    %{
      name: :org_settings,
      path: Routes.live_path(socket, PanicWeb.EditOrgLive, org.slug),
      label: "Settings",
      icon: :cog
    }
  end
