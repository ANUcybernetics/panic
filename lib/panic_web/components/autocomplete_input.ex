defmodule PanicWeb.AutocompleteInput do
  @moduledoc """
  A simple autocomplete input component for Phoenix LiveView.

  This is vendored from the autocomplete_input package to avoid dependency
  conflicts with Phoenix LiveView 1.1+.

  Original: https://github.com/launchscout/autocomplete_input
  """
