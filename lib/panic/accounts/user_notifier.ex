defmodule Panic.Accounts.UserNotifier do
  @moduledoc """
  When sending an email we use the functions in Panic.Email to generate the Email struct ready for Swoosh to send off.
