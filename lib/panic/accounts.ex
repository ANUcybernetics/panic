defmodule Panic.Accounts do
  ...
  alias Panic.Accounts.{User, UserToken, UserNotifier, UserTOTP}
  ...
  def user_lifecycle_action("after_register", user, _) do
    Panic.Logs.log_async("register", %{user: user})
    Panic.Orgs.sync_user_invitations(user)
